...
},{"./views/control-panel":6,"./views/violencemap":8,"backbone":9,"bootstrap":10,"d3":24,"jquery":26,"underscore":28}],2:[function(require,module,exports){
...
var jade_mixins = {};
var jade_interp;
;var locals_for_with = (locals || {});(function (filters, undefined) {
buf.push("<ul class=\"active-filter-indicator\">");
// iterate filters
;(function(){
  var $$obj = filters;
...
buf.push("<li" + (jade.attr("data-filter", key, true, false)) + " class=\"active-filter\">" + (jade.escape(null == (jade_interp = val) ? "" : jade_interp)) + "</li>");
    }
...
buf.push("</ul>");}.call(this,"filters" in locals_for_with?locals_for_with.filters:typeof filters!=="undefined"?filters:undefined,"undefined" in locals_for_with?locals_for_with.undefined:typeof undefined!=="undefined"?undefined:undefined));;return buf.join("");
};
...
buf.push("<span class=\"show-controls\">Show map filters</span><div class=\"filter-indicator\"></div><div class=\"control-panel docked\"><span class=\"show-controls\">Hide map filters</span><div class=\"control-section\"><h4 class=\"control-title\">View</h4><div data-toggle=\"buttons\" class=\"btn-group\"><label class=\"btn btn-default active\">Total<input type=\"radio\" name=\"view\" value=\"\" autocomplete=\"off\" checked=\"checked\"/></label><label class=\"btn btn-default\">Rate<input type=\"radio\" name=\"view\" value=\"rate\" autocomplete=\"off\"/></label><label class=\"btn btn-default\"> Disparity<input type=\"radio\" name=\"view\" value=\"disparity\" autocomplete=\"off\"/></label></div></div><div class=\"control-section\"><h4 class=\"control-title\">Gender</h4><div data-toggle=\"buttons\" class=\"btn-group\"><label class=\"btn btn-default active\">All<input type=\"radio\" name=\"gender\" value=\"\" autocomplete=\"off\" checked=\"checked\"/></label><label class=\"btn btn-default\">Female<input type=\"radio\" name=\"gender\" value=\"female\" autocomplete=\"off\"/></label><label class=\"btn btn-default\"> Male<input type=\"radio\" name=\"gender\" value=\"male\" autocomplete=\"off\"/></label></div></div><div class=\"control-section\"><h4 class=\"control-title\">Race</h4><div data-toggle=\"buttons\" class=\"btn-group\"><label class=\"btn btn-default active\">All<input type=\"radio\" name=\"race\" value=\"\" autocomplete=\"off\" checked=\"checked\"/></label><label class=\"btn btn-default\">Black<input type=\"radio\" name=\"race\" value=\"black\" autocomplete=\"off\"/></label><label class=\"btn btn-default\"> White<input type=\"radio\" name=\"race\" value=\"white\" autocomplete=\"off\"/></label><label class=\"btn btn-default\"> Hispanic<input type=\"radio\" name=\"race\" value=\"hispanic\" autocomplete=\"off\"/></label><label class=\"btn btn-default\"> Asian<input type=\"radio\" name=\"race\" value=\"asian\" autocomplete=\"off\"/></label></div></div><div class=\"control-section\"><h4 class=\"control-title\">Armed?</h4><div data-toggle=\"buttons\" class=\"btn-group\"><label class=\"btn btn-default active\">All<input type=\"radio\" name=\"armed\" value=\"\" autocomplete=\"off\" checked=\"checked\"/></label><label class=\"btn btn-default\">Armed<input type=\"radio\" name=\"armed\" value=\"allegedly armed\" autocomplete=\"off\"/></label><label class=\"btn btn-default\">Vehicle<input type=\"radio\" name=\"armed\" value=\"vehicle\" autocomplete=\"off\"/></label><label class=\"btn btn-default\"> Unarmed<input type=\"radio\" name=\"armed\" value=\"unarmed\" autocomplete=\"off\"/></label></div></div></div>");;return buf.join("");
};
...
buf.push("<filter id=\"dropshadow\" height=\"130%\"><fegaussianblur in=\"SourceAlpha\" stddeviation=\"3\"></fegaussianblur><!-- stdDeviation is how much to blur--><feoffset dx=\"2\" dy=\"2\" result=\"offsetblur\"></feoffset><!-- how much to offset--><femerge><femergenode></femergenode><!-- this contains the offset blurred image--><femergenode in=\"SourceGraphic\"></femergenode><!-- this contains the element that the filter is applied to--></femerge></filter>");;return buf.join("");
};
},{"jade/runtime":25}],6:[function(require,module,exports){
...
},{"../templates/control-panel.jade":4,"./filter-indicator":7}],7:[function(require,module,exports){
...
},{"../templates/active-filters.jade":3}],8:[function(require,module,exports){
...
},{"../lib/colors/colorbrewer":2,"../templates/filters.jade":5,"topojson":27}],9:[function(require,module,exports){
(function (global){
//     Backbone.js 1.2.0
...
},{"jquery":26,"underscore":28}],10:[function(require,module,exports){
...
},{"fs":23}],26:[function(require,module,exports){
/*!
